...
const en: Record<string, string> = {
  ...
  // Region
  "opt.North America": "North America (USA, Canada, Mexico)",
  "opt.Europe": "Europe (UK, Germany, France, etc.)",
  "opt.Middle East & North Africa (MENA)": "Middle East & North Africa (Saudi Arabia, UAE, Egypt, Iraq, etc.)",
  "opt.South Asia": "South Asia (India, Nepal, Pakistan, Bangladesh, Sri Lanka)",
  "opt.East & Southeast Asia": "East & Southeast Asia (China, Japan, Korea, Thailand, etc.)",
  "opt.Sub-Saharan Africa": "Sub-Saharan Africa (Nigeria, Kenya, South Africa, etc.)",
  "opt.Latin America & Caribbean": "Latin America & Caribbean (Brazil, Argentina, Colombia, etc.)",
  "opt.Oceania": "Oceania (Australia, New Zealand, etc.)",
  "opt.Other": "Other",
  // Income
...
const ar: Record<string, string> = {
  ...
  "opt.North America": "أمريكا الشمالية (الولايات المتحدة، كندا، المكسيك)",
  "opt.Europe": "أوروبا (بريطانيا، ألمانيا، فرنسا، إلخ)",
  "opt.Middle East & North Africa (MENA)": "الشرق الأوسط وشمال أفريقيا (السعودية، الإمارات، مصر، العراق، إلخ)",
  "opt.South Asia": "جنوب آسيا (الهند، نيبال، باكستان، بنغلاديش، سريلانكا)",
  "opt.East & Southeast Asia": "شرق وجنوب شرق آسيا (الصين، اليابان، كوريا، تايلاند، إلخ)",
  "opt.Sub-Saharan Africa": "أفريقيا جنوب الصحراء (نيجيريا، كينيا، جنوب أفريقيا، إلخ)",
  "opt.Latin America & Caribbean": "أمريكا اللاتينية والكاريبي (البرازيل، الأرجنتين، كولومبيا، إلخ)",
  "opt.Oceania": "أوقيانوسيا (أستراليا، نيوزيلندا، إلخ)",
  "opt.Other": "أخرى",
...
const de: Record<string, string> = {
  ...
  "opt.North America": "Nordamerika (USA, Kanada, Mexiko)",
  "opt.Europe": "Europa (UK, Deutschland, Frankreich, usw.)",
  "opt.Middle East & North Africa (MENA)": "Naher Osten & Nordafrika (Saudi-Arabien, VAE, Ägypten, Irak, usw.)",
  "opt.South Asia": "Südasien (Indien, Nepal, Pakistan, Bangladesch, Sri Lanka)",
  "opt.East & Southeast Asia": "Ost- & Südostasien (China, Japan, Korea, Thailand, usw.)",
  "opt.Sub-Saharan Africa": "Subsahara-Afrika (Nigeria, Kenia, Südafrika, usw.)",
  "opt.Latin America & Caribbean": "Lateinamerika & Karibik (Brasilien, Argentinien, Kolumbien, usw.)",
  "opt.Oceania": "Ozeanien (Australien, Neuseeland, usw.)",
  "opt.Other": "Andere",
